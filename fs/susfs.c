...
/* ===== SukiSU-Ultra Extended API ===== */

/* susfs_add_sus_path_loop - alias of susfs_add_sus_path for loop-based addition */
#ifdef CONFIG_KSU_SUSFS_SUS_PATH
...
/* susfs_enable_log - wrapper around susfs_set_log */
#ifdef CONFIG_KSU_SUSFS_ENABLE_LOG
...
/* susfs_add_sus_map - stub for SUS_MAP feature */
#ifdef CONFIG_KSU_SUSFS_SUS_MAP
int susfs_add_sus_map(void __user *arg) {
	/* Stub - SUS_MAP not implemented in this SUSFS version */
	SUSFS_LOGI("susfs_add_sus_map: not implemented in kernel-4.19 SUSFS\n");
	return 0;
}
#endif
...
/* susfs_get_enabled_features - return bitmask of enabled features */
...
/* susfs_show_variant - return SUSFS variant string */
...
/* susfs_show_version - return SUSFS version string */
