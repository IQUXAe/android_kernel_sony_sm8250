...
#define CMD_SUSFS_ADD_SUS_MAP 0x555f1
#define CMD_SUSFS_ENABLE_AVC_LOG_SPOOFING 0x555f2
#define CMD_SUSFS_SUS_SU 0x60000

#define SUSFS_MAGIC 0x55553 /* magic value passed from userspace ksu_susfs tool */
...
#define TASK_STRUCT_MNT_NS_UMOUNTED BIT(25)
